...
export class IndexComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.galleryImages = [
      {
        small: '../../assets/images/banner/banner-1.1.png',
        medium: '../../assets/images/banner/banner-1.1.png',
        big: '../../assets/images/banner/banner-1.1.png',
      },
      {
        small: '../../assets/images/banner/banner-2.2.png',
        medium: '../../assets/images/banner/banner-2.2.png',
        big: '../../assets/images/banner/banner-2.2.png',
      }
    ];
  ...
  GetAllFunctionArea() {
    this.masterService.GetAllFunctionArea().subscribe(res => {
      ...
      if (this.AreaResponce != null && this.AreaResponce.length > 0) {
        ...
        for(var i=0; i<10;i++){
          var functional = {
            'id':this.AreaResponce[i].id,
            'alias':this.AreaResponce[i].alias,
            'image':this.AreaResponce[i].image,
            'totalValidJob':this.AreaResponce[i].totalValidJob
          }
          this.FunctionAreaList.push(functional);         
        }       
      }
    });
  }
  FunctionAreaList:any=[];
  GetViewAllFunctionArea() {
    this.masterService.GetAllFunctionArea().subscribe(res => {
      this.AreaResponce = res;
      if (this.AreaResponce != null && this.AreaResponce.length > 0) {
         this.FunctionAreaList = this.AreaResponce;
         this.viewLess=true;
         this.viewAll=false;        
      }
    });
