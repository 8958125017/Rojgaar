...
import { InterviewedCandidateRoutes } from './InterviewedCandidate.routes';
import { JobpostService } from '../../../../Services/jobpost.service';
import { InterviewedCandidateComponent } from '../InterviewedCandidate.Component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild(InterviewedCandidateRoutes),
    NgxPaginationModule,
...
export class InterviewedCandidateModule { }
