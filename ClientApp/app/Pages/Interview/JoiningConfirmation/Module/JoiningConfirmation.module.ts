...
import { JoiningConfirmationRoutes } from './JoiningConfirmation.routes';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild(JoiningConfirmationRoutes)
  ],
  declarations: [
    JoiningConfirmationComponent
  ],
  providers: [
    UserInfoService,
    MasterService,
...
export class JoiningConfirmationModule { }
