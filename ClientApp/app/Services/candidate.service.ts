...
GetCandidateDocumentType() {
 ...
 GetCandidateDocument(candidateID:any) {
  const token = sessionStorage.getItem('usertoken');
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json','Authorization': token }) };
 return this.httpClient.get(environment.apiUrl + 'Candidate/GetCandidateDocument/' + candidateID, httpOptions);
 }
...
const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json'}) };
 ...
 GetPlacedCandidate() {
  ...
  const token = sessionStorage.getItem('usertoken');
  const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token }) };
  return this.httpClient.get(environment.apiUrl + 'CandidateUploadsalary/GetPlacedCandidate',httpOptions);
 }

// upload excel document 

 uploadEXCELFile(uploadFileDetail:any)
 {
  const token = sessionStorage.getItem('usertoken');
  const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json','Authorization': token  }) };
  return this.httpClient.post(environment.apiUrl + 'Candidate/UploadCandidateExcel/',uploadFileDetail, httpOptions);
 }
